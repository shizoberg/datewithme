...
router.get('/me', requireAuth, async (req: AuthRequest, res: Response) => {
  ...
  res.json({ user: { id: user.id, name: user.name, email: user.email, username: user.username, avatarId: user.avatarId, bio: user.bio, city: user.city, district: user.district, photoUrl: user.photoUrl, personalityTags: user.personalityTags, onboardingDone: user.onboardingDone } })
})
